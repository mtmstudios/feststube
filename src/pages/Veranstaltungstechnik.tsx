      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 bg-background overflow-hidden">
          ...
          <div className="container max-w-4xl text-center relative">
            ...
            >
              Veranstaltungstechnik mieten in{" "}
            ...
            >
              Professionelle PA-Anlagen, Lichtanlagen und Mikrofone für Hochzeiten,
              Firmenfeiern, Geburtstage und mehr. Inkl. Aufbau und Techniker vor Ort.
            </motion.p>
